<template>
  <section class="about_project_page__section">
    ...
    <div class="about_project_page__section__text_block">
...
<style scoped>
  ...
  .about_project_page__section__content > ul li{
    margin-top: 30px;
    font-size: 30px;
